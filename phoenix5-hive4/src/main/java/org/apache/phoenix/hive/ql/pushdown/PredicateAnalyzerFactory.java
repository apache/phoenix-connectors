...
import org.apache.phoenix.hive.ql.pushdown.PhoenixPredicateAnalyzer.FieldValidator;

public class PredicateAnalyzerFactory {
    public static PhoenixPredicateAnalyzer createPredicateAnalyzer(List<String> ppdColumnList,
                                                                 FieldValidator fieldValdator) {
        // Create analyzer for conditions  =, <, <=, >, >=
        PhoenixPredicateAnalyzer analyzer = PhoenixPredicateAnalyzer.createAnalyzer(false);
