...
public class PhoenixQueryBuilderTest {
    ...
    private PhoenixSearchCondition mockedIndexSearchCondition(String comparisionOp,
                                                            Object constantValue,
                                                            Object[] constantValues,
                                                            String columnName,
                                                            String typeString,
                                                            boolean isNot) {
        PhoenixSearchCondition condition = mock(PhoenixSearchCondition.class);
    ...
    public void testBuildQueryWithCharColumns() throws IOException {
        ...
        List<PhoenixSearchCondition> searchConditions = new ArrayList<>(Arrays.asList(
