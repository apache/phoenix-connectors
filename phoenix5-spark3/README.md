...
For maintaining compatibility with source type `"org.apache.phoenix.spark"`, `SaveMode.Overwrite` is accepted but it behave same way as `SaveMode.Append`.
...
- DataSourceV1 implementation was removed, source type `"org.apache.phoenix.spark"` uses DatasourceV2 since connector 6.0.0 release.
